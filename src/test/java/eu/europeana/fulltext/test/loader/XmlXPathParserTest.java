package eu.europeana.fulltext.test.loader;

import eu.europeana.fulltext.batchloader.AnnoPageRdf;
import eu.europeana.fulltext.batchloader.XMLXPathParser;
...
public class XmlXPathParserTest {
    ...
    public static void loadExampleFiles() throws IOException {
        ...
        apRdf1 = XMLXPathParser.eatIt(annoPage1FileContents, "1");
    }
    ...
    public void testPageId() {
        ...
        AnnoPageRdf apRdf = XMLXPathParser.eatIt(annoPage1FileContents, testPageId);
