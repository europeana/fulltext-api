...
public class HitSelectorV2Test {

    @Autowired
    private ObjectMapper objectMapper;

    private JacksonTester<HitSelectorV2> json;
    ...
    public void testSerialization() throws IOException {
        JsonContent<HitSelectorV2> serialized = json.write(new HitSelectorV2("", "word", ""));
        assertThat(serialized).extractingJsonPathStringValue("@.@type")
                .isEqualTo("oa:TextQuoteSelector");
    }
}