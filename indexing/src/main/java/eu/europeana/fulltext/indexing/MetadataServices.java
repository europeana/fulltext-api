...
public class MetadataServices {
    private static final Logger logger = LogManager.getLogger(MetadataServices.class);
     ...
     * @return
     */
    protected static SolrDocument getFullDocument(String europeana_id){
    ...
    public static List<String> getDocumentsModifiedMetadata(LocalDateTime last_timestamp_update_metadata) throws IOException {
